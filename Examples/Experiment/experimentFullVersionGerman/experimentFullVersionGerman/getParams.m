function params = getParams(params)
    ...
    params.freeTrainingDuration1 = 2*60; % 1 minute
    params.maxTrainingDuration1 = 8*60; % 8 minutes
    params.freeTrainingDuration2 = 2*60; % 1 minute
    params.maxTrainingDuration2 = 8*60; % 8 minutes
    params.maxTaskDuration = 23*60; % 23 minutes
